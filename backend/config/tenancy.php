...
return [
     ...
     *
     * VERA usa base de datos unica con columna tenant_id + global scope
     * (seccion 3.1 del CLAUDE.md raiz), NO una base de datos separada por
     * tenant. Por eso DatabaseTenancyBootstrapper queda deshabilitado a
    ...
    'bootstrappers' => [
        ...
        // Stancl\Tenancy\Bootstrappers\FilesystemTenancyBootstrapper::class, // evidencia usa prefijo manual tenants/{id}/ en R2, no disks por tenant
